...
<div class="card">
    ...
    <div class="card-body"> 
        <form class="text-dark" action="{{ route('studentUpdate', $student->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!-- Foto -->
                ...
                <div class="col-xl-6 mb-3">
                    @if($student->photo_student)
                        <div class="mt-2">
                            <span>Foto Lama</span>
                            <img src="{{ asset('uploads/students/' . $student->photo_student) }}" width="80" class="rounded">
                            <span>Foto Baru</span>
                ...
                <div class="col-xl-6 mb-3">
                    ...
                    <select name="service_student" class="form-control">
                        <option value="antar" {{ $student->service_student == 'antar' ? 'selected' : '' }}>Antar</option>
                        <option value="jemput" {{ $student->service_student == 'jemput' ? 'selected' : '' }}>Jemput</option>
                        <option value="antarjemput" {{ $student->service_student == 'antarjemput' ? 'selected' : '' }}>Antar-Jemput</option>
                    </select>
                ...
                <div class="col-xl-6 mb-3">
                    ...
                    <select name="status_student" class="form-control">
                        <option value="active" {{ $student->status_student == 'active' ? 'selected' : '' }}>Aktif</option>
                        <option value="inactive" {{ $student->status_student == 'inactive' ? 'selected' : '' }}>Tidak Aktif</option>
                    </select>
